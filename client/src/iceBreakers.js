const funny = ['How much deeper do you think the ocean would be if sponges didn’t grow in it?', 
...
'What is the strangest thing you’ve every put in the fridge?',
...
const smart = ['If you could =go back in time and change history, what would you change? Why?',
'What is the one question you would like to have answered',
'What four famous living people would you like to have over for dinner?',
'Which four historical figures would you like to have over for drinks?',
...
const rich = ['What is the name of an exotic country that you would like to go to for a vacation?',
'What is the best meal you have ever had on vacation?',
'If you could buy another car right now, what would you buy?',
'If you could go anywhere in the world, where would you go?',
'When is the last time you visited Dubai?',
'What is your favorite golf course?'
];
const partyAnimal = ['Which was the funniest prank played on you or played by you?',
...
const marriageMaterial = [];
const professional = ['What would be your dream job?',
...
const outdoorsy = ['If you could be an Olympic athlete, what sport would you compete in?',
'If you could climb any mountain, which would you choose?',
